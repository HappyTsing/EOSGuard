...
import edu.uestc.eosguard.framework.bean.afl.AFLGeneratorInfo;
...
import edu.uestc.eosguard.framework.type.StringGenerator;
    ...
    private String getAflRandomStr() throws AFLException, InterruptedException {
        ...
        // while (count++ < 15) {
            try {
                ...
                // System.out.println("count:"+count+" filepath: "+filepath);
