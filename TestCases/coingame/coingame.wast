(module
  ...
  (import "env" "tapos_block_num" (func $env.tapos_block_num (type $t2)))
  ...
  (import "env" "memset" (func $env.memset (type $t5)))
  (import "env" "memmove" (func $env.memmove (type $t5)))
  (import "env" "__unordtf2" (func $env.__unordtf2 (type $t6)))
  (import "env" "__eqtf2" (func $env.__eqtf2 (type $t6)))
  (import "env" "__multf3" (func $env.__multf3 (type $t7)))
  (import "env" "__addtf3" (func $env.__addtf3 (type $t7)))
  (import "env" "__subtf3" (func $env.__subtf3 (type $t7)))
  (import "env" "__netf2" (func $env.__netf2 (type $t6)))
  ...
  (import "env" "__divtf3" (func $env.__divtf3 (type $t7)))
  (import "env" "__letf2" (func $env.__letf2 (type $t6)))
  (import "env" "__trunctfdf2" (func $env.__trunctfdf2 (type $t11)))
  (import "env" "__getf2" (func $env.__getf2 (type $t6)))
  ...
  (func $apply (type $t13) (param $p0 i64) (param $p1 i64) (param $p2 i64)
    ...
    i32.add
    global.set $g0)
  (func $f30 (type $t0) (param $p0 i32) (param $p1 i64) (param $p2 i64) (param $p3 i32) (param $p4 i32)
    ...
    i32.add
    global.set $g0)
  (func $f31 (type $t3) (param $p0 i32) (param $p1 i32) (result i32)
  ...
  (func $f36 (type $t4) (param $p0 i32) (param $p1 i32)
    ...
    i32.add
    global.set $g0)
  (func $f37 (type $t3) (param $p0 i32) (param $p1 i32) (result i32)
  ...
  (func $f46 (type $t15) (param $p0 i32)
    call $env.abort
    unreachable)
  (func $f47 (type $t3) (param $p0 i32) (param $p1 i32) (result i32)
  ...
  (func $f48 (type $t4) (param $p0 i32) (param $p1 i32)
    ...
    i32.shl
    i32.store8)
  (func $f49 (type $t15) (param $p0 i32)
    call $env.abort
    unreachable)
  (func $f50 (type $t15) (param $p0 i32))
  (func $f51 (type $t14) (param $p0 i32) (result i32)
    i32.const 8360
    local.get $p0
    call $f52)
  (func $f52 (type $t3) (param $p0 i32) (param $p1 i32) (result i32)
    ...
    i32.const 0)
  (func $f53 (type $t14) (param $p0 i32) (result i32)
    ...
    i32.store
    local.get $l4)
  (func $f54 (type $t15) (param $p0 i32)
  ...
  (global $__heap_base i32 (i32.const 16842))
  (global $__data_end i32 (i32.const 16842))
  ...
  (elem $e0 (i32.const 1) $f30)
  (data $d0 (i32.const 8192) "eosio.token\00")
  (data $d1 (i32.const 8204) "transfer\00")
  (data $d2 (i32.const 8213) "multiplication overflow\00")
  (data $d3 (i32.const 8237) "multiplication underflow\00")
  (data $d4 (i32.const 8262) "write\00")
  (data $d5 (i32.const 8268) "magnitude of asset amount must be less than 2^62\00")
  (data $d6 (i32.const 8317) "invalid symbol name\00")
  (data $d7 (i32.const 8337) "read\00")
  (data $d8 (i32.const 8342) "get\00")
  (data $d9 (i32.const 16756) "malloc_from_freed was designed to only be called after _heap was completely allocated\00"))
